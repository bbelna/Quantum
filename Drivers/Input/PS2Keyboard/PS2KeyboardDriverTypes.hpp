/**
 * @file Drivers/Input/PS2Keyboard/PS2KeyboardDriverTypes.hpp
 * @brief Declares core @ref @QDrvs::Input::PS2Keyboard types.
...
using namespace Quantum::Drivers::Input::PS2Keyboard;
