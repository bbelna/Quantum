/**
 * @file Include/Quantum/Threading/OS/IOSProcess.hpp
 * @brief Declares @ref @QThrd::OS::IOSProcess.
...
namespace Quantum::Threading::OS {
  /**
   * @brief Interface for OS-specific process backends.
   */
  class IOSProcess {
    public:
      /**
       * @brief Gets the @ref ProcessID of the calling process.
       ...
       * @param pid The @ref ProcessID to query.
       ...
       * @param pid The @ref ProcessID to update.
